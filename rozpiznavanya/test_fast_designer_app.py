...
class Ui_MainWindow(QMainWindow):
    def __init__(self):
        ...
        print("Початок першого зчитування історія (designer_app.py)")
        time_history_designer1 = time.time()
        with open('history.json', 'r', encoding='utf-8') as f:
            self.history_data = json.load(f)
        print(f"Час зчитування історія (designer_app.py) {time.time()-time_history_designer1}")
    ...
    def check_history(self):  # перевірка чи оновилася наша історія
        ...
        print("Початок зчитування історії для відображення у додатку (designer_app.py)")
        time_history_designer = time.time()
        with open('history.json', 'r', encoding='utf-8') as f:
            self.history_data = json.load(f)
        ...
        print(f"Час зчитування історії для відображення у додатку (designer_app.py) {time.time()-time_history_designer}")
